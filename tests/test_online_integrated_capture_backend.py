...
def test_episode_seal_keeps_start_actor_when_next_actor_activates() -> None:
    ...
    assert capture_backend._pinned_actor_seal_identity(
        ...
        "active_actor_model_revision": contract.identity.policy_revision,
        "active_actor_publication_cycle": None,
        "active_actor_policy_epoch": None,
    }
                ...
                return {
                    ...
                    "learner_polyak_steps": 2,
                        ...
                        "capture_window": {
                            ...
                            "current_episode_sampled": False,
                            "current_episode_replay_membership": False,
                            "sampled_session_ids": ["older-session"],
                            "start": {
                                "completed_learner_cycles": 0,
                                "partial_cycle_q_updates": 0,
                                "total_twin_q_optimizer_steps": 256,
                                "warmup_twin_q_optimizer_steps": 256,
                                "joint_twin_q_optimizer_steps": 0,
                            ...
                            "end": {
                                "completed_learner_cycles": 1,
                                "partial_cycle_q_updates": 0,
                                "total_twin_q_optimizer_steps": 258,
                                "warmup_twin_q_optimizer_steps": 256,
                                "joint_twin_q_optimizer_steps": 2,
                                "residual_actor_optimizer_steps": 1,
                                "residual_actor_update_attempts": 1,
                                "residual_actor_updates_skipped_no_gradient": 0,
                                "actor_parameter_publication_events": 0,
                                "periodic_checkpoint_events": 0,
                            },
                            "delta": {
                                "completed_learner_cycles": 1,
                                "partial_cycle_q_updates": 0,
                                "total_twin_q_optimizer_steps": 2,
                                "warmup_twin_q_optimizer_steps": 0,
                                "joint_twin_q_optimizer_steps": 2,
                                "residual_actor_optimizer_steps": 1,
                                "residual_actor_update_attempts": 1,
                                "residual_actor_updates_skipped_no_gradient": 0,
