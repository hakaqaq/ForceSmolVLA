"""Minimal P0 ForcePrior skeleton with fail-closed RTC isolation."""
...
from .configuration_forceprior import (
...
from .configuration_forceprior import OFFLINE_FULL_FINETUNE, ONLINE_HIL_VLM_FROZEN
...
class ForceVLAFlowMatching(VLAFlowMatching):
    def __init__(self, config: ForcePriorConfig, rtc_processor=None):
...
class ForcePriorPolicy(SmolVLAPolicy):
    config_class = ForcePriorConfig
    name = "force_prior"

    def __init__(self, config: ForcePriorConfig, **kwargs: Any):
