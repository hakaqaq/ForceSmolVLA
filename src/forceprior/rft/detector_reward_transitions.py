...
from forceprior.training_data import prepare_training_sample
...
def load_training_transitions(root: Path, *, task_id: str | None = None):
    ...
    _require(
        manifest.get("schema")
        in {
            "forceprior.forcerft_offline_reward_transitions",
            "forcesmolvla.forcerft_offline_reward_transitions",
        }
