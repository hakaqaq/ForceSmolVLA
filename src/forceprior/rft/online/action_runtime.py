...
CONCURRENT_MAX_SERVICE_LATENCY_NS = 443_161_677
...
PRODUCTION_DURABLE_RESUME = "UNVERIFIED"
...
class SelectionLedgerEntry:
    ...
    def to_accepted_ack(self, *, clock_domain_id: str):
        ...
        from forceprior.rft.online.transition_authority import AcceptedAck
...
def project_acknowledged_runtime_macro(
    ...
    *,
    ...
    from forceprior.rft.online.transition_authority import causal_zoh_ack_macro
