...
INTEGRATED_CAPTURE_SCHEMA = "forceprior_ack_residual_integrated_capture.v2"
LEGACY_INTEGRATED_CAPTURE_SCHEMA = "forceprior-stage3-integrated-capture-v1"
    ...
    if mode == "policy-execute":
        ...
        if deployment_binding is not None:
            ...
            if (
                ...
                != "forceprior-live-deployment-binding-v1"
