...
def build() -> None:
    ...
    sources = [
        ...
        ("tools/preflight_s2_g5_single_cycle_gpu.py", "data_and_g4_runtime"),
        ("tools/run_s2_g7a_worker.py", "parent_initialization_runtime"),
        ("tools/run_s2_g7a_r2_worker.py", "action_contract_v2_install"),
